...
export default function LayoutMainView() {
    ...
    const { selectedPendingDiveSite } = useContext(
        SelectedPendingDiveSiteContext,
    );
    const { selectedPartnerRequest } = useContext(
        SelectedPartnerRequestContext,
    );
    return (
                        ...
                        data={[
                            {
                                key: 't-1',
                                title: 'Sea Life',
                                content: SeaLifePhotoList,
                            },
                            {
                                key: 't-2',
                                title: 'Dive Sites',
                                content: DiveSiteList,
                            },
                            {
                                key: 't-3',
                                title: 'Partner Requests',
                                content: PartnerRequestList,
                            },
                            {
                                key: 't-3',
                                title: 'Trip Requests',
                                content: 'Trip Edit & Delete Requests',
                            },
                        ]}
                    />
                </div>
